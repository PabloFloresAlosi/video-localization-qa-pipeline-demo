...
```text
scripts/01\\\\\\\\\\\\\\\_validate\\\\\\\\\\\\\\\_srt\\\\\\\\\\\\\\\_structure.py
```
...
```text
scripts/02\\\\\\\\\\\\\\\_check\\\\\\\\\\\\\\\_subtitle\\\\\\\\\\\\\\\_reading\\\\\\\\\\\\\\\_speed.py
```
...
```text
scripts/03\\\\\\\\\\\\\\\_generate\\\\\\\\\\\\\\\_qa\\\\\\\\\\\\\\\_summary.py
```
